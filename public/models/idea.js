...
(function( undefined ){
    ...
    A.model.Idea  = Backbone.Model.extend({
        ...
        defaults: {
            ...
            tile_image: 'http://beta.tinkermob.com/img/lightblub.jpg',//this.collection.nextOrder(),
            user_icon_image: 'http://beta.tinkermob.com/img/lightblub.jpg',//this.collection.nextOrder(),
